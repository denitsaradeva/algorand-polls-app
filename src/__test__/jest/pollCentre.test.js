...
import Poll, { getPolls, isOptedIn, castVote, retrieveVotes, toBytes, createNewPoll } from "../../utils/pollCentre";
...
describe('createNewPoll', () => {
  ...
  it('createNewPoll should return expected output', async () => {
    retValue = await createNewPoll(senderAddress,pollTitle,pollOptions,duration);
    expect(retValue).toBeTruthy();
  });
});